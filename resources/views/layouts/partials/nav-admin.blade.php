...
<nav class="flex-1 p-4 space-y-1 overflow-y-auto no-scrollbar">
    ...
    <a href="{{ route('coach.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all @if(request()->routeIs('coach.*')) bg-emerald-50 text-emerald-700 @else text-slate-600 hover:bg-slate-50 hover:text-slate-900 @endif">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
